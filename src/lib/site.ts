...
export const SITE = {
  ...
  tagline: 'DeFi yield platforms reviewed for risk, transparency, and real utility.',
  description:
    'Independent DeFi yield reviews covering lending protocols, liquid staking, vaults, stablecoin yield, smart contract risk, liquidity, and protocol transparency.',
  author: {
    name: 'Gelei',
    aboutPath: '/about',
